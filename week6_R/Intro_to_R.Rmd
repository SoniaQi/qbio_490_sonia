...
```{r setup Exercise 2.3}
    ...
    knitr::opts_knit$set(root.dir = normalizePath("/Users/soniaqi/Documents/QBio-490/qbio_490_sonia")) 
```
...
three_fav_colors <- c("black", "white", "blue")
print(c(name, age, birthday, three_fav_colors))
# age is int; three_fav_colors is a vector of strings; the rest are string
```
...
ifelse(8<11, print("if"), ifelse(3>=5, print("else if1"), ifelse("i"=="i", print("else if2"), print("else"))))
```
